...
const ProjectArtifacts = () => {
  return <div>
    <img src="/sd.github.io/gryffindorpics/HousePic.jpeg" width="100%" height="300"></img>
    
    <h2> <br></br>Prototype Evolution</h2>
      <p>
    ...
    &emsp;&emsp;Furthermore for future use, Venus can be used to advise gamers in other browser adventures, this will be avalible via a browser plugin. <br></br>
    </p>
    ...
    <p>
    &emsp;&emsp;Many thanks to the following companies and people . . .<br></br><br></br>
    &emsp;&emsp;Arthur Kot, The House, for providing a suspensefully  <strong><a href="https://the-house.arturkot.pl/"> fun game. </a></strong><br></br>
    &emsp;&emsp;Sony, for providing the massive background in proving this is <strong><a href="https://patentscope.wipo.int/search/en/detail.jsf?docId=US321828987&tab=NATIONALBIBLIO"> possible. </a></strong> <br></br>
    &emsp;&emsp;mL5, for giving us an excellent machine learning template <strong><a href="https://ml5js.org/"> and library. </a></strong><br></br>
    &emsp;&emsp;vSyncTester, for showing us telemetry data <strong><a href="https://www.vsynctester.com/testing/mouse.html"> in real time. </a></strong><br></br> 

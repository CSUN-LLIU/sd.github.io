...
const TeamMembers = () => {
  ...
  <div class="col">
   ...
   <Image src="/sd.github.io/gryffindorpics/cinnamoroll.jpg" height="250px" width="250px" border="5px" class="mb-3" alt="" />
   <h5 class="card-title">Jazlyn Fernandez</h5>
      ...
      <div class="col">
    <div class="card h-100">
   <Image src="/sd.github.io/gryffindorpics/mymelody.jpg" height="250px" width="250px" border="5px" class="mb-3" alt="My Melody" />
   <h5 class="card-title">Angelina Nantanapramoth</h5>
      ...
      <div class="col">
    <div class="card h-100">
   <Image src="/sd.github.io/gryffindorpics/pochacco.jpg" height="250px" width="250px" border="5px" class="mb-3" alt="Pochacco" />
   <h5 class="card-title">Kathareeya Atthajaroon</h5>
      ...
      <div class="col">
    <div class="card h-100">
    <Image src="/sd.github.io/gryffindorpics/keroppi.jpg" height="250px" width="250px" border="5px" class="mb-3" alt="Keropi" />
    <h5 class="card-title">Daniel Esquivel</h5>
      <p class="card-text">
      {`Outside of class I enjoy hanging out with friends and learning new skills like drawing. 
      ...
      <div class="col">
    <div class="card h-100">
    <Image src="/sd.github.io/gryffindorpics/badtzmaru.jpeg" height="250px" width="250px" border="5px" class="mb-3" alt="Badtz Maru" />
    <h5 class="card-title">Juan Vazquez</h5>
      ...
      <div class="col">
    <div class="card h-100">
    <Image src="/sd.github.io/gryffindorpics/pompom.jpeg" height="250px" width="250px" border="5px" class="mb-3" alt="Badtz Maru" />
    <h5 class="card-title">Erick Bravo</h5>
    <p class="card-text">

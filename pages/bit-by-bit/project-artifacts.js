  ...
  */
  ...
  return (
    <div className={styles.container} style={{textAlign: `center`}}>
      ...
      <h2><u>Progress of Spring 2023</u></h2>
      <div>
        <br></br>
        <h3>2023 Nursing Virtual Reality Senior Design Poster</h3>
          <img src={"https:i.imgur.com/8bJY5e4.png"} width="100%" height="100%" alt="Nursing Virtual Reality Senior Design Poster" />
      </div>
      ...
      <div>
        ...
        <h3>Nursing Research Day Presentation</h3>
          <img src={"https://i.imgur.com/ZXLWeF3.png"} width="100%" height="100%" alt="First slide of Nursing Research Day Slides" />
          ...
          <u>Link to Canva Presentation Slides (Spring 2023)</u></a>
      </div>
      ...
      <div>
        ...
        <p>
          <img src={"https://i.imgur.com/C9i1pBG.png"} width="60%" height="60%" alt="User perspective of animations menu UI in NVR program" />
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          <img src={"https://i.imgur.com/ljG0nLD.png"} width="60%" height="60%" alt="User perspective of virtual patient laying down in NVR program" />
        </p>
      </div>
      ...
      <div>
        <br></br>
        <br></br>
        <h4>Maya editor perspective of patient model</h4>
        <p>
          <img src={"https://i.imgur.com/GGaZf2n.png"} width="80%" height="80%" alt="Maya editor perspective of patient model" />
        </p>
      </div>
      ...
      <u><h2>Progress of Fall 2022</h2></u>
      <div>
        <br></br>
      ...
      <p>
      <br></br>
      <h4>Draft page of website interface for patient customization feature</h4>
      <Image className={styles.header}
